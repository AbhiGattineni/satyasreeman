...
function Sliderimg() {
    ...
    const handleOnNextClick = () => {count = (count + 1) % Images.length;
        setCurrentIndex(count);
    }
    const handleOnPrevClick = () => {const productsLength = Images.length;
    ...
    return (
        <div>
            <div className='flex justify-between drop-shadow-md px-5 bg-sky-500 bg-opacity-0 sticky top-0'>
                <div className='logo p-6 text-2xl drop-shadow-lg text-black font-bold text-white'>
                    <h1>SatyaSreeman</h1>
                </div>
                <div className='hidden menu drop-shadow-md list-none lg:flex lg:flex-row text-white uppercase my-7 text-sm'>
                    <li className='menu-list mx-2 hover:underline decoration-2'><a href='#' className='mx-10'>bussines</a></li>
                    <li className='menu-list mx-2 hover:underline decoration-2'><a href='#' className='mx-10'>community</a></li>
                    <li className='menu-list mx-2 hover:underline decoration-2'><a href='#' className='mx-10'>about us</a></li>
                    <li className='menu-list mx-2 hover:underline decoration-2'><a href='#' className='mx-10'>careers</a></li>
                </div>
