...
const Careerresume = () => {
    return (
        <form className="bg-white p-5">
            <div className="flex justify-left px-8 p-3">
                <div className="relative">
                    ...
                    <label for="username" className="absolute left-0 top-1 cursor-text peer-focus:text-xs peer-focus:-top-4 transition-all">UserName *</label>
                </div>
            </div>
            <div className="flex justify-left px-8 p-3">
                <div className="relative">
            ...
            <div className="flex justify-left px-8 p-2">
                <label>Resume *</label>
            </div>
